  ...
  return (
    <section className="relative overflow-hidden w-full min-h-[92vh] flex items-center justify-center border-b-2 border-white/10 bg-[#0A0A0A]">
      ...
      <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
        ...
        {/* Vignette Overlay for readability and premium look */}
      ...
      <div className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 py-24 text-center">
        <div className="inline-block select-none">
          ...
          {/* Main Title */}
          <h1 className="font-display font-800 text-5xl sm:text-8xl leading-[0.95] tracking-tighter uppercase text-white mb-6">
            THE BEST BURGER
            <br />
            <span className="text-[#FF6B00]">IN TOWN.</span>
          </h1>
          {/* Refined Description */}
          <p className="text-sm sm:text-lg max-w-2xl mx-auto font-display font-700 tracking-wider text-[#F5EFE6] leading-relaxed uppercase opacity-95">
